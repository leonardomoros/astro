...
import { Search, LayoutTemplate, Paintbrush, PackageCheck } from 'lucide-react';
import type { UxUiTranslations } from '../content/uxUiTranslations';

const COLOR_FROM = '#ec4899';
const COLOR_TO   = '#a855f7';
const ICONS = [Search, LayoutTemplate, Paintbrush, PackageCheck];

interface Props { t: UxUiTranslations['process'] }

export default function UxUiProcess({ t }: Props) {
              ...
              >
                {!isLast && (
                  <div style={{
                    ...
                    width: '1px', background: `linear-gradient(to bottom, ${COLOR_FROM}, ${COLOR_TO})`, opacity: 0.35,
                  }} />
                )}
                <div
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-xs font-bold px-2 py-0.5 rounded" style={{ background: `${COLOR_FROM}22`, color: COLOR_FROM }}>
                      {i + 1}
                    </span>
