...
interface Props {
  t: EmailMarketingTranslations['results'];
}

export default function EmailResults({ t }: Props) {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at 50% 50%, ${COLOR_FROM}, transparent 70%)`,
        }}
      />
