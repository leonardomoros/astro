...
import { Search, Target, Users, MousePointer2, RefreshCw, BarChart3 } from 'lucide-react';
import type { PaidAdsTranslations } from '../content/paidAdsTranslations';

const COLOR_FROM = '#f43f5e';
const COLOR_TO   = '#ef4444';
const ICONS = [Search, Target, Users, MousePointer2, RefreshCw, BarChart3];
const COLORS = [COLOR_FROM, COLOR_TO, '#a855f7', '#10b981', '#3b82f6', '#f59e0b'];

interface Props { t: PaidAdsTranslations['features'] }

export default function PaidAdsFeatures({ t }: Props) {
