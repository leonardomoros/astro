...
import { ClipboardList, Gauge, Image, Globe, Code2, Bell } from 'lucide-react';
import type { WebOptTranslations } from '../content/webOptimizationTranslations';

const COLOR_FROM = '#06b6d4';
const COLOR_TO   = '#0ea5e9';
const ICONS  = [ClipboardList, Gauge, Image, Globe, Code2, Bell];
const COLORS = [COLOR_FROM, COLOR_TO, '#10b981', '#a855f7', '#f59e0b', '#ec4899'];

interface Props { t: WebOptTranslations['features'] }

export default function WebOptFeatures({ t }: Props) {
