...
interface Props { t: LandingPageTranslations['faq'] }

export default function LandingFAQ({ t }: Props) {
  ...
  return (
    <section className="relative py-24 border-t border-[var(--border)] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#3b82f6]/4 rounded-full blur-3xl" />
      </div>
        ...
        <div className="space-y-3">
          {t.items.map((item, i) => (
            <div
              ...
              style={{ borderColor: open === i ? '#3b82f630' : undefined }}
            >
              <button
              ...
              >
                ...
                <ChevronDown
                  ...
                  style={{ transform: open === i ? 'rotate(180deg)' : 'rotate(0deg)', color: open === i ? '#3b82f6' : undefined }}
                />
              </button>
              <div
              ...
              >
                <p className="px-6 pb-5 text-[13px] text-[var(--text-muted)] leading-relaxed">{item.answer}</p>
              </div>
            </div>
          ))}
        </div>
