...
import { Search, ListOrdered, Wrench, ShieldCheck } from 'lucide-react';
import type { WebOptTranslations } from '../content/webOptimizationTranslations';

const COLOR_FROM = '#06b6d4';
const COLOR_TO   = '#0ea5e9';
const ICONS = [Search, ListOrdered, Wrench, ShieldCheck];

interface Props { t: WebOptTranslations['process'] }

export default function WebOptProcess({ t }: Props) {
